...
public class UserJdbcDaoImpl extends JdbcDaoImpl {
	...
	public UserJdbcDaoImpl() {
		super();
		this.setUsersByUsernameQuery(GET_USER_BY_NAME);
		this.setAuthoritiesByUsernameQuery(GET_ROLE_ID_BY_NAME);
	}
		...
		return getJdbcTemplate().query(getUsersByUsernameQuery(), new String[] { username },
				new RowMapper<UserDetails>() {
					public UserDetails mapRow(ResultSet rs, int rowNum) throws SQLException {
						...
						return new UserVO(username, password, name, AuthorityUtils.NO_AUTHORITIES);
					}
